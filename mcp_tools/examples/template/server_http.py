#!/usr/bin/env python3
"""
Template for an MCP HTTP server.
This is a starting point for creating a custom tool that follows the MCP protocol over HTTP.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Custom Tool HTTP Server")
    parser.add_argument(
        "--host",
        default="0.0.0.0",
    ...
    # Log starting info
    logger.info(f"Starting MCP HTTP server at http://{host}:{port}")
